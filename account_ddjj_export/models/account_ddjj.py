...
class DDJJExport:
    ...
    def format_line(self, record):
        ...
        for apunte in record.apunte_ids:
            ...
            formatted_line += '{:.2f}'.format(self.montoComprobante(comprobante,tipo_operacion) - self.montoSujetoARetencion(comprobante,53,tipo_operacion) ).replace('.', ',').rjust(16, '0') #Importe IVA 
