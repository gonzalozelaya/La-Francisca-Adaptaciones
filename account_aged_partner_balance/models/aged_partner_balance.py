...
class AgedPartnerBalanceCustomHandler(models.AbstractModel):
    _name = 'account.aged.partner.balance.report.handler.new'
    _inherit = 'account.report.custom.handler'
    _description = 'Aged Partner Balance Custom Handler New'
    ...
    def _report_custom_engine_aged_receivable_new(self, expressions, options, date_scope, current_groupby, next_groupby, offset=0, limit=None, warnings=None):
...
class AgedPayableCustomHandler(models.AbstractModel):
    _name = 'account.aged.payable.report.handler.new'
    _inherit = 'account.aged.partner.balance.report.handler.new'
    _description = 'Aged Payable Custom Handler New'
...
class AgedReceivableCustomHandler(models.AbstractModel):
    _name = 'account.aged.receivable.report.handler.new'
    _inherit = 'account.aged.partner.balance.report.handler.new'
    _description = 'Aged Receivable Custom Handler New'
